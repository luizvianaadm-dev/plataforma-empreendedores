...
<input type="checkbox" checked={accepted} onChange={(e) => setAccepted(e.target.checked)} className="mt-1 w-5 h-5 text-indigo-600 rounded" />
<span className="text-gray-800">Li, compreendi e <strong>concordo</strong> com a Politica de Privacidade e LGPD</span>
</label>
<p className="text-sm text-gray-500 mt-4">* Voce deve aceitar esta politica para criar sua conta e utilizar a plataforma.</p>
</div>
<div className="bg-white rounded-xl shadow-lg p-8">
<label className="flex items-start space-x-3 cursor-pointer">
<input type="checkbox" checked={companyListingAuthorized} onChange={(e) => setCompanyListingAuthorized(e.target.checked)} className="mt-1 w-5 h-5 text-green-600 rounded" />
<span className="text-gray-800">Autorizo minha empresa a aparecer no diretorio <strong>Empresas Cadastradas</strong> com nome e website</span>
</label>
